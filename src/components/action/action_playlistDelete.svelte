<script>
    ...
    import SVGDelete from "../../../public/images/delete.svg";
...
{#if menuIsVisible}
    <Menu anchor="left-center" toggleElement={document.querySelector("#js-action-playlist_delete_" + id)} bind:isVisible={menuIsVisible}>
